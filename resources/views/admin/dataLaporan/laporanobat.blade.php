        ...
        <div class="block-header block-header-default">
            <div class="mb-1">
                <div class="btn-group" role="group" aria-label="Horizontal Primary">
                    <a href="{{ route('cetak-laporan-obat') }}" target="_blank" type="button" class="btn btn-primary"
                    ...
                    @foreach ($laporanobat as $key)
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell fs-sm text-center">
                                {{ $key->DiagnosaToDetail[0]->RelasidetailPenyakit->DetailPenyakitToPenyakit->penyakitToObat[0]->namaObat }}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
